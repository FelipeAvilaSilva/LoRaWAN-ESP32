...
uint32_t  license[4] = {0xD26820C9,0xAFCC7EFF,0xC2CC2EBB,0xFF6C8F5B};
...
void loop()
{
  switch(state)
  {
    case STATUS_TX:
      delay(2000);
        readsensor();
        sprintf(txpacket,"%f",temperature);
        sprintf(txpacket+strlen(txpacket),"%f",humidity);
